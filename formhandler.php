...
$subject = 'Email from modernshelter.com'; // if your client has more than one web site, you can put the site name here.

// for troubleshooting, uncomment the two lines below. Send your form, and you'll get a browser message showing your results.
//echo "mail ('joellavin@live.com', $subject, $body, $from);";
//exit();

//Sends email, with elements created above
mail ('joellavin@live.com', $subject, $body, $from);

header('Location: index.php#contact'); // replace "thx.html" with the name and path to your actual thank you page